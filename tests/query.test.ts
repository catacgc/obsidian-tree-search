...
import {matchQuery, parseQuery, shouldPrune} from "../src/query";
...
describe('parseSearchQuery', () => {
	it('queries', () => {
		...
		expect(matchQueryT(text, "sample -example")).toBeTruthy();
		expect(matchQueryT(text, "sample text | testing -example")).toBeTruthy();
		expect(matchQueryT(text, "sample -text | testing -for")).toBeFalsy();
